...
console.log(sam.insertAt('one',0))
console.log(sam.toString())
console.log(sam.insertAt('ten',4))
console.log(sam.toString())
console.log(sam.insertAt('two',2))
console.log(sam.toString())
console.log(sam.insertAt('three',4))
console.log(sam.toString())
console.log(sam.remove(3))
console.log(sam.toString())
console.log(sam.remove(4))
console.log(sam.remove(3))
console.log(sam.toString())
console.log(sam.remove(0))
console.log(sam.toString())
